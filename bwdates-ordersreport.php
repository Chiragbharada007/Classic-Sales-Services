...
<html lang="en">
    <head>
        ...
        <title>Classic Sales & Services | Between Dates Order Report</title>
...
<hr />
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
<?php $query=mysqli_query($con,"SELECT orders.id,orderStatus,orderDate,users.name,users.contactno 
