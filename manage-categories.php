...
<html lang="en">
    <head>
        ...
        <title>Classic Sales & Services| Manage Categories</title>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
<?php $query=mysqli_query($con,"SELECT category.id as catid,category.categoryName,category.categoryDescription,category.creationDate,category.updationDate,admin.username from category join admin on admin.id");
$cnt=1;
