...
<html lang="en">
    <head>
        ...
        <title>Classic Sales & Services | Manage Sub-Categories</title>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
<?php $query=mysqli_query($con,"SELECT category.categoryName,subcategory.creationDate,subcategory.updationDate,subcategory.id as subid,admin.username from subcategory join category on subcategory.categoryid=category.id join admin on admin.id");
$cnt=1;
