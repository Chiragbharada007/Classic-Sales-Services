...
<html lang="en">
    <head>
        ...
        <title>Classic Sales & Services | Manage New Orders</title>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
<?php $query=mysqli_query($con,"SELECT orders.id, orders.orderStatus, orders.orderDate, users.name FROM orders JOIN users ON users.id = orders.userId where (orderStatus is null  || orderStatus='')");
$cnt=1;
